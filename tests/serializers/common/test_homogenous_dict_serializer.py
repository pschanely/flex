from flex.compat.serializers import DRFShim
...
class RolesSerializer(DRFShim, HomogenousDictSerializer):
    """
...
class ParentSerializer(DRFShim, serializers.Serializer):
